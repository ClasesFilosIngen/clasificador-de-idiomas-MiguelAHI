...
articulo_Eng1 = re.sub(r'[^a-zA-ZñÑáéíóúÁÉÍÓÚàèìòùÀÈÌÒÙäëïöüÄËÏÖÜçÇßâêîôûÂÊÎÔÛ\s]', '', articulo_Eng1)
...
articulo_Esp1= re.sub(r'[^a-zA-ZñÑáéíóúÁÉÍÓÚàèìòùÀÈÌÒÙäëïöüÄËÏÖÜçÇßâêîôûÂÊÎÔÛ\s]', '', articulo_Esp1)
